...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--load", type=str, default="fabriceyhc/bert-base-uncased-yahoo_answers_topics"
    )
    parser.add_argument("--data_name", type=str, default="yahoo_answers_topics")
